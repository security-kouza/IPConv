...
int is_group0    (cell * L) { return is_IDENTIFIER_or_TYPE(SYMBOL_GROUP0    ,L) ; }
int is_group1    (cell * L) { return is_IDENTIFIER_or_TYPE(SYMBOL_GROUP1    ,L) ; }
int is_duplex    (cell * L) { return is_IDENTIFIER_or_TYPE(SYMBOL_DUPLEX    ,L) ; }
